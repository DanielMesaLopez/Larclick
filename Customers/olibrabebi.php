      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="olibrabebi.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='olibrasa.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Platos a la Carta</h5></a>     
      <a class='btn btn-primary btn-sm'  href='olibraba.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Bandejas</h5></a>
      <a class='btn btn-primary btn-sm'  href='olibrapo.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Pollo Frito y Combos</h5></a>
      <a class='btn btn-primary btn-sm'  href='olibraad.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Adicionales</h4></a>
      <a class='btn btn-primary btn-sm'  href='olibraso.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Sopas</h5></a>  
      <a class='btn btn-primary btn-sm'  href='olibrabebi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Bebidas</h5></a>
...
$query=mysql_query("select * from productos where rest_id=11 and tipo_prod='BE' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
          ...
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
                    ...
                    <a class='btn btn-block btn-danger' href='olibrasaDetalle.php?cart=".$query2['prod_id']."'><h4><span class='fa fa-shopping-cart'></span> Añadir al carrito</h4></a>
            </div>
          </div>
        </div>";
