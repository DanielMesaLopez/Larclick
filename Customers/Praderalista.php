...
<?php
 ...
 include("config.php");
  ...
  if(isset($_GET['delete_id']))
  {
    ...
    header("Location: Praderalista.php");
  }
...
<?php
  ...
  if(isset($_GET['update_id']))
  {
    ...
    header("Location: Praderapedido.php");
  }
...
echo "<td>";
    echo "<a class='btn btn-block btn-danger' href='Pradera.php?id=1' ><h4><span class='fa fa-shopping-cart'></span> Seguir Comprando!</h4></a>";
    echo "</td>";
