      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="Parrilladabebi.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
$query=mysql_query("select * from productos where rest_id=5 and tipo_prod='BE' LIMIT $start, $limit");
