...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='MrChef.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Platos a la Carta</h5></a>
      <a class='btn btn-primary btn-sm'  href='chefpz.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Pescados y Cazuela</h5></a>  
      <a class='btn btn-primary btn-sm'  href='chefban.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Bandejas</h4></a>  
      <a class='btn btn-primary btn-sm'  href='chefaz.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Arroces</h5></a> 
      <a class='btn btn-primary btn-sm'  href='chefcomi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Comida Rapida</h5></a>
      <a class='btn btn-primary btn-sm'  href='chefmz.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Mazorcadas</h5></a>
      <a class='btn btn-primary btn-sm'  href='chefadi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Adicionales</h4></a>      
      <a class='btn btn-primary btn-sm'  href='chefbebi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Bebidas</h5></a>
...
$query=mysql_query("select * from productos where rest_id=8 and tipo_prod='PC' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
            ...
            <center> 
            <h6 class='font-impact font-red'>".$query2['nombre_prod']."</h6>
            </center>
            </div>
          ...
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
                    ...
                    <a class='btn btn-block btn-danger' href='MrChefDetalle.php?cart=".$query2['prod_id']."'><h4><span class='fa fa-shopping-cart'></span> Añadir al carrito</h4></a>
            </div>
          </div>
        </div>";
