      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="Grillcomi.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
     ...
     <img src="../Assets/img/portadacomi.png">
      <div id="page"><li>       
...
$query=mysql_query("select * from productos where rest_id=2 and tipo_prod='CR' LIMIT $start, $limit");
