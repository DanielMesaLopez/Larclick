      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="tacoot.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='tacoriendo.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Platos a la Carta</h5></a>
      <a class='btn btn-primary btn-sm'  href='tacohm.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Hamburguesas</h5></a> 
      <a class='btn btn-primary btn-sm'  href='tacope.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Perros</h5></a>      
      <a class='btn btn-primary btn-sm'  href='tacoas.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Arepas Rellenas</h5></a>
      <a class='btn btn-primary btn-sm'  href='tacoot.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Otros</h5></a>                
...
$query=mysql_query("select * from productos where rest_id=16 and tipo_prod='OT' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
          ...
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
                    ...
                    <a class='btn btn-block btn-danger' href='tacoDetalle.php?cart=".$query2['prod_id']."'><h4><span class='fa fa-shopping-cart'></span> Añadir al carrito</h4></a>
            </div>
          </div>
        </div>";
