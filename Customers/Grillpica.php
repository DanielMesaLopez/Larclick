      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="Grillpica.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='GrillBrasa&Sabor.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Platos a la Carta</h5></a>
      <a class='btn btn-primary btn-sm'  href='Grillpz.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Pescados</h5></a>
      <a class='btn btn-primary btn-sm'  href='Grillpica.php?id=1'><h5><span class='fa fa-shopping-cart'></span>Picadas</h5></a>  
      <a class='btn btn-primary btn-sm'  href='Grillband.php?id=1'><h5><span class='fa fa-shopping-cart'></span>Bandejas</h5></a>
      <a class='btn btn-primary btn-sm'  href='Grillarr.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Arroces</h5></a>     
      <a class='btn btn-primary btn-sm'  href='Grillcomi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Comida Rapida</h5></a>
      <a class='btn btn-primary btn-sm'  href='Grillco.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Combos</h5></a>
      <a class='btn btn-primary btn-sm'  href='Grilladi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Adicionales</h4></a>
      <a class='btn btn-primary btn-sm'  href='Grillbebi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Bebidas</h5></a>
      
      <li><div id="contenedor">        
     
     <img src="../Assets/img/portadapc.png">
      <div id="page"><li>       
...
$query=mysql_query("select * from productos where rest_id=2 and tipo_prod='PD' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
            ...
            <center> 
            <h5 class='font-impact font-red'>".$query2['nombre_prod']."</h5>
            </center>
            </div>
          ...
          <center><h5>  ".$query2['detalle_prod']." </h5></center>
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
          
                    <a class='btn btn-block btn-danger' href='GrillBrasa&SaborDetalle.php?cart=".$query2['prod_id']."'><h4><span class='fa fa-shopping-cart'></span> Añadir al carrito</h4></a>
            </div>
          </div>
        </div>";
