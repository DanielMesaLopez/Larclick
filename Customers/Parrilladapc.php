      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="Parrilladapc.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='ParrilladaLatina.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Platos a la Carta</h5></a>
      <a class='btn btn-primary btn-sm'  href='Parrilladapz.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Pescados</h5></a>
      <a class='btn btn-primary btn-sm'  href='Parrilladapc.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Picadas</h5></a>
      <a class='btn btn-primary btn-sm'  href='Parrilladaaz.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Arroces</h4></a>     
      <a class='btn btn-primary btn-sm'  href='Parrilladacomi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Comida Rapida</h5></a>
      <a class='btn btn-primary btn-sm'  href='Parrilladacomb.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Combos</h5></a>
      <a class='btn btn-primary btn-sm'  href='Parrilladabebi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Bebidas</h5></a>
...
$query=mysql_query("select * from productos where rest_id=5 and tipo_prod='PD' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
          ...
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
                    ...
                    <a class='btn btn-block btn-danger' href='ParrilladaLatinaDetalle.php?cart=".$query2['prod_id']."'><h4><span class='fa fa-shopping-cart'></span> Añadir al carrito</h4></a>
            </div>
          </div>
        </div>";
