...
<?php
  ...
  if(isset($_GET['update_id']))
  {
    ...
    header("Location: tacopedido.php");
  }
    ...
    while($row=$stmt->fetch(PDO::FETCH_ASSOC))
    {
      ...
      ?>
         ...
         <td>
                  ...
                  <a class="btn btn-block btn-danger" href="?delete_id=<?php echo $row['id_pedido']; ?>" title="click for delete" onclick="return confirm('¿Estás segura de eliminar este artículo?')"><h4><span class='fas fa-trash-alt'></span> Quitar Producto</h4></a>
