...
$query=mysql_query("select * from productos where rest_id=15 and tipo_prod='LIP' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
          ...
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
                    ...
                    <a class='btn btn-block btn-danger' href='liptusDetalle.php?cart=".$query2['prod_id']."'><h5><span class='fa fa-shopping-cart'></span> Añadir al carrito</h5></a>
            </div>
          </div>
        </div>";
