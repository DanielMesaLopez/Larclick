      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="tacohm.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
$query=mysql_query("select * from productos where rest_id=16 and tipo_prod='HM' LIMIT $start, $limit");
