...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='Laindustrial.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Hamburguesas</h5></a>
      <a class='btn btn-primary btn-sm'  href='Lainduspe.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Hot Dogs</h5></a> 
      <a class='btn btn-primary btn-sm'  href='Lainduspd.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Picadas</h5></a>
...
$query=mysql_query("select * from productos where rest_id=17 and tipo_prod='HM' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
          ...
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
                    ...
                    <a class='btn btn-block btn-danger' href='LaindusDetalle.php?cart=".$query2['prod_id']."'><h4><span class='fa fa-shopping-cart'></span> Añadir al carrito</h4></a>
            </div>
          </div>
        </div>";
