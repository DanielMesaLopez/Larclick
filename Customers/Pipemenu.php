      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="Pipemenu.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
      ...
      <img src="../Assets/img/portadamenu.png">
      <div id="page"><li>       
...
$query=mysql_query("select * from productos where rest_id=1 and tipo_prod='MI' LIMIT $start, $limit");
