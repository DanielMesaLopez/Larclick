...
<?php
 ...
 include("config.php");
  ...
  {
    header("Location: ParrilladaLatina.php");
  }
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="ParrilladaLatina.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
          <li><a href="ParrilladaLatinalista.php"> &nbsp; <span class='fa fa-cart-plus'></span> Lista de Compras</a></li>
          <li><a href="ParrilladaLatinapedido.php"> &nbsp; <span class='fas fa-smile'></span> Mis Pedidos</a></li>         
...
<div>
<center><div class="planel logo_mim">Parrillada Latina</center></div>
<div class="w3-content w3-section" style="max-width:1400px">
  <img class="miestilo" src="../Assets/Promociones/promoparrilla.jpg" style="width:100%"   height="300">
  <img class="miestilo" src="../Assets/Promociones/promoparrilla2.jpg" style="width:100%"   height="300">
 
  </div>
</center></div>

<div class="planel logo_mimo"><center><img src='../Assets/logosR/parrilladalatina.png' class='imgRedonda' /></center></div>
...
<div id="page-wrapper">         
 ...
 <form role="form" method="post" action="ParrillaOrden.php">
  ...
  <table class="table table-bordered table-responsive" style="color:black;background-color:#ffffff">
   ...
   <tr>
    ...
    <tr>
        <td colspan="2"><button type="submit" name="ParrillaOrden" class="btn btn-primary">
        <h4><span class="fa fa-shopping-cart"></span> Agregar</h4>
        </button>
        
        <a class="btn btn-danger" href="ParrilladaLatina.php?id=1"><h4> <span class="fa fa-arrow-left"></span> Cancelar</h4></a>
