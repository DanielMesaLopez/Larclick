...
<?php
 ...
 include("config.php");
  ...
  {
    header("Location: TablitaCriolla.php");
  }
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="TablitaCriolla.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
          <li><a href="Tablitalista.php"> &nbsp; <span class='fa fa-cart-plus'></span> Lista de Compras</a></li>
          <li><a href="Tablitapedido.php"> &nbsp; <span class='fas fa-smile'></span> Mis Pedidos</a></li>         
...
<div>
<center><div class="planel logo_mim">La Tablita Criolla</center></div>
...
<div class="planel logo_mimo"><center><img src='../Assets/logosR/tablitacriolla.png' class='imgRedonda' /></center></div>
...
<div id="page-wrapper">         
 ...
 <form role="form" method="post" action="TablitaOrden.php">
  ...
  <table class="table table-bordered table-responsive" style="color:black;background-color:#ffffff">
   ...
   <tr>
    ...
    <tr>
        <td colspan="2"><button type="submit" name="TablitaOrden" class="btn btn-primary">
        <h4><span class="fa fa-shopping-cart"></span> Agregar</h4>
        </button>
        
        <a class="btn btn-danger" href="TablitaCriolla.php?id=1"><h4> <span class="fa fa-arrow-left"></span> Cancelar</h4></a>
