...
<?php
 ...
 include("config.php");
  ...
  {
    header("Location: PipeCompany.php");
  }
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="PipeCompany.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
          <li><a href="Pipelista.php"> &nbsp; <span class='fa fa-cart-plus'></span> Lista de Compras</a></li>
          <li><a href="Pipepedido.php"> &nbsp; <span class='fas fa-smile'></span> Mis Pedidos</a></li>         
...
<div>
<center><div class="planel logo_mim">Pipe & Company</center></div>
<div class="w3-content w3-section" style="max-width:1400px">
  <img class="miestilo" src="../Assets/Promociones/promopipe (2).png" style="width:100%"   height="300">
  <img class="miestilo" src="../Assets/Promociones/promopipe.png" style="width:100%"  height="300">
  <img class="miestilo" src="../Assets/Promociones/promopipe (4).png" style="width:100%"   height="300">
  <img class="miestilo" src="../Assets/Promociones/promopipe (3).png" style="width:100%"   height="300">
   <img class="miestilo" src="../Assets/Promociones/promopipe (5).png" style="width:100%"   height="300">
    <img class="miestilo" src="../Assets/Promociones/promopipe (6).png" style="width:100%"   height="300">
  </div>
</center></div>

<div class="planel logo_mimo"><center><img src='../Assets/logosR/pipecompany.png' class='imgRedonda' /></center></div>
...
<div id="page-wrapper">         
 ...
 <form role="form" method="post" action="PipeOrden.php">
  ...
  ?>
    ...
    <div class="alert alert-default" style="color:white;background-color:#C70039">
         <center><h3> <span class="fa fa-shopping-cart"></span> Detalles del pedido</h3></center>
        </div>
    
     <td><input class="form-control" type="hidden" name="producto_pedido" value="<?php echo $nombre_prod; ?>" /></td>
      <td><input class="form-control" type="hidden" name="estable_pedido" value="<?php echo $estable_prod; ?>" /></td>
    <td><input class="form-control" type="hidden" name="precio_pedido" value="<?php echo $precio_prod; ?>" /></td>
    <td><input class="form-control" type="hidden" name="id_cliente" value="<?php echo $id_cliente; ?>" /></td>
    
  <table class="table table-bordered table-responsive" style="color:black;background-color:#ffffff">
   
  
   
    <tr>
      <td><h4><label class="control-label">Nombre del Producto</label></h4></td>
        <td><input class="form-control" type="text" name="v1" value="<?php echo $nombre_prod; ?>" disabled/></td>    
    </tr>
    

   <tr>
      <td><h4><label class="control-label">Precio</label></h4></td>
        <td><input class="form-control" type="text" name="v2" value="<?php echo $precio_prod; ?>" disabled/></td>
    </tr>
     
     <tr>
      <td><h4><label class="control-label">Cantidad</label></h4></td>
        <td><input class="form-control" type="text" placeholder="Ingrese la Cantidad" name="cantidad_pedido" value="1" onkeypress="return isNumber(event)" onpaste="return false"  required />

           <tr>
      <td><h4><label class="control-label">Forma de Pago</label></h4></td>
        <td><select name="pago_pedido" class="form-control" required>
        <option value="" >Seleccione la forma de pago</option>
        <option value="Efectivo">Efectivo </option>
        <option value="Nequi">Nequi</option>
        <option value="Daviplata">Daviplata</option>
        <option value="Datáfono">Datáfono</option>
</select><h4>Nota: Recuerde que la forma de pago por Datáfono tiene un adicional del 5% que se cobrará a la entrega del pedido solicitado, las demás formas de pago como Efectivo, Nequi, Daviplata no tiene ningun cobro adicional. </h4></td>
    </tr>
    
    <tr>
      <td><h4><label class="control-label">Sugerencia(Opcional)</label></h4></td>
        <td><input class="form-control" type="text" name="observa_pedido"  placeholder="Escriba su solicitud"/></td>
    ...
    <tr>
        <td colspan="2"><button type="submit" name="PipeOrden" class="btn btn-primary">
        <h4><span class="fa fa-shopping-cart"></span> Agregar</h4>
        </button>
        
        <a class="btn btn-danger" href="PipeCompany.php?id=1"><h4> <span class="fa fa-arrow-left"></span> Cancelar</h4></a>
