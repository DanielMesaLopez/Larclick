...
<?php
 ...
 include("config.php");
  ...
  if(isset($_GET['delete_id']))
  {
    ...
    header("Location: sopaslista.php");
  }
...
<?php
  ...
  if(isset($_GET['update_id']))
  {
    ...
    header("Location: sopaspedido.php");
  }
...
include("config.php");
  ...
  if($stmt->rowCount() > 0)
  {
    ...
    echo "<td>";
    echo "<a class='btn btn-block btn-danger' href='sopas.php?id=1' ><h4><span class='fa fa-shopping-cart'></span> Seguir Comprando!</h4></a>";
    echo "</td>";
