      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="Grillbebi.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='Grillpz.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Pescados y Mariscos</h5></a>
     ...
     <img src="../Assets/img/portadabebi.png">
      <div id="page"><li>       
...
$query=mysql_query("select * from productos where rest_id=2 and tipo_prod='BE' LIMIT $start, $limit");
