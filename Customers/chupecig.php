      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="chupecig.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='chupelupe.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Cervezas</h5></a>     
      <a class='btn btn-primary btn-sm'  href='chupelic.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Licores</h5></a>
      <a class='btn btn-primary btn-sm'  href='chupecig.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Cigarrillos</h5></a>
      
      
      <li><div id="contenedor">        
     
    <img src="../Assets/img/portadaciga.png">
      <div id="page"><li>       
...
$query=mysql_query("select * from productos where rest_id=13 and tipo_prod='CIG' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
          ...
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
                    ...
                    <a class='btn btn-block btn-danger' href='chupeDetalle.php?cart=".$query2['prod_id']."'><h4><span class='fa fa-shopping-cart'></span> Añadir al carrito</h4></a>
            </div>
          </div>
        </div>";
