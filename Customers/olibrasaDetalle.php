...
<div id="page-wrapper">         
 ...
 <form role="form" method="post" action="olibrasaOrden.php">
  ...
  <table class="table table-bordered table-responsive" style="color:black;background-color:#ffffff">
   ...
   <tr>
    ...
    <tr>
        <td colspan="2"><button type="submit" name="olibrasaOrden" class="btn btn-primary">
        <h4><span class="fa fa-shopping-cart"></span> Agregar</h4>
        </button>
        
        <a class="btn btn-danger" href="olibrasa.php?id=1"><h4> <span class="fa fa-arrow-left"></span> Cancelar</h4></a>
