      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li class="active"><a href="Pataconpata.php?id=1"> &nbsp; <span class='fa fa-shopping-cart'></span> Comprar Ahora</a></li>
...
<main class="container">
  <span>
      ...
      <a class='btn btn-primary btn-sm'  href='Patacon.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Platos a la Carta</h5></a>  
       <a class='btn btn-primary btn-sm'  href='Pataconpata.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Patacón</h4></a>
        <a class='btn btn-primary btn-sm' href='Pataconmexi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Mexicana</h4></a>   
      <a class='btn btn-primary btn-sm'  href='Pataconcomi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Comida Rapida</h5></a>
      <a class='btn btn-primary btn-sm'  href='Pataconcomb.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Combos</h5></a>
      <a class='btn btn-primary btn-sm'  href='Pataconbebi.php?id=1'><h5><span class='fa fa-shopping-cart'></span> Adicionales</h5></a>
      
      <li><div id="contenedor">        
     
     <img src="../Assets/img/portadapa.png">
      <div id="page"><li>       
...
$query=mysql_query("select * from productos where rest_id=9 and tipo_prod='PA' LIMIT $start, $limit");
...
while($query2=mysql_fetch_array($query))
{
  ...
  echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#000000;'>
          ...
          <center><h3> Precio: &dollar; ".$query2['precio_prod']." </h3></center>    
                    ...
                    <a class='btn btn-block btn-danger' href='PataconDetalle.php?cart=".$query2['prod_id']."'><h4><span class='fa fa-shopping-cart'></span> Añadir al carrito</h4></a>
            </div>
          </div>
        </div>";
