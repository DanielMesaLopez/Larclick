    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Productos Anterior Pedido por el Cliente</strong> </h3></center>
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  <?php
include("config.php");
	$stmt = $DB_con->prepare("SELECT * FROM detallepedido where id_cliente='$id_cliente' and estado_pedido='Ordered_Finished'");
	$stmt->execute();
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "<tr>";
		echo "<td colspan='4' align='center' style='font-size:18px;'>"."Nombre del Cliente: <span style='color:red;'>".$nombre_cliente." ".$apellido_cliente."</span> | "."Correo: <span style='color:red;'>".$correo_cliente."</span> | "."Cedula: <span style='color:red;'>".$cedula_cliente."</span> | "."Dirección: <span style='color:red;'>".$direccion_cliente."</span> | "."Barrio: <span style='color:red;'>".$barrio_cliente."</span> | "."Celular: <span style='color:red;'>".$celular_cliente." </span>";
		echo "</td>";
