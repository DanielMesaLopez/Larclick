...
<?php
	...
	if(isset($_GET['view_id']) && !empty($_GET['view_id']))
	{
		...
		$stmt_edit = $DB_con->prepare('SELECT * FROM cliente WHERE id_cliente=:id_cliente');
		$stmt_edit->execute(array(':id_cliente'=>$view_id));
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="customers.php"> &nbsp; &nbsp; &nbsp; Gestionar Clientes</a></li>
					<li><a href="orderdetails.php"> &nbsp; &nbsp; &nbsp; Detalle del Pedido</a></li>
        ...
        <div id="page-wrapper">
			 ...
			 <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Detalles Pedidos del Cliente</strong> </h3></center>
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
              <thead>
                <tr>
                <th><center>Producto</th></center>
                 <th><center>Establecimiento</th></center>
                 <th><center>Sugerencia</th></center>
                 <th><center>Forma de Pago</th></center>
                <th><center>Precio</th></center>
				 <th><center>Cantidad</th></center>
                 <th><center>Total</th></center>
				 <th><center>Fecha del pedido</th></center>
			  ...
			  <?php
include("config.php");
	$stmt = $DB_con->prepare("SELECT * FROM detallepedido where id_cliente='$id_cliente' and estado_pedido='Ordered'");
	$stmt->execute();
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "<tr>";
		echo "<td colspan='3' align='right' style='font-size:20px;'><b><span style='color:red'>Precio Total Pedido Pago Establecimiento:</span>";
		echo "</td>";
		echo "<td><h3>&dollar; ".$totalx;
		 echo "</td></h3>";

		echo "<tr>";
		echo "<td colspan='3' align='right' style='font-size:20px;'><b><span style='color:red'>Precio Total Pedido Incluye Domicilio: </span>".$total=3600;
		echo "</td>";
		echo "<td><h3>&dollar; ".$totalx=$totalx+$total;
		 echo "</td></h3>";
		echo "<td colspan='3' align='right' style='font-size:20px;'>Cliente: ".$nombre_cliente." ".$apellido_cliente." <br>Dirección: ".$direccion_cliente." <br>Barrio: ".$barrio_cliente."<br>Celular: ".$celular_cliente;
		echo "</td>";
		
		 
		
		 echo "<td>";
		 echo "<a class='btn btn-danger' href='customers.php'><span class='glyphicon glyphicon-backward'></span> Atras<a/>'";
		 echo "</td>";
	...
	else
	{
        ...
        <div class="col-xs-12">
        	<div class="alert alert-warning">
            	<span class="glyphicon glyphicon-info-sign"></span> &nbsp; Aún no hay productos pedidos ...
            </div>
        </div>
        <?php
	}
